...
namespace GameEngine
{
  ...
  //Comparators for the glyph sorting
  bool SpriteBatch::CompareFrontToBack(Glyph* _a, Glyph* _b)
  {
    return (_a->m_depth < _b->m_depth);
  }
  bool SpriteBatch::CompareBackToFront(Glyph* _a, Glyph* _b)
  {
    return (_a->m_depth > _b->m_depth);
  }
  bool SpriteBatch::CompareTexture(Glyph* _a, Glyph* _b)
  {
