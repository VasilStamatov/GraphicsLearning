...
void GameEngine::GUI::Init(const std::string& _resourceDirectory)
{
...
void GameEngine::GUI::DestroyGUI()
{
  //destroy the GUI
...
void GameEngine::GUI::OnSDLEvent(SDL_Event& _evnt) 
{
  //handle SDL events
...
void GameEngine::GUI::LoadScheme(const std::string& _schemeFile)
{
  //load the scheme file
  CEGUI::SchemeManager::getSingleton().createFromFile(_schemeFile);
}

CEGUI::Window* GameEngine::GUI::CreateWidget(const std::string& _type, const glm::vec4& _destRectPerc, const glm::vec4& _destRectPix, const std::string& _name /*= ""*/)
{
  //create a new widget
...
CEGUI::Window* GameEngine::GUI::CreateWidget(CEGUI::Window* _parent, const std::string& _type, const glm::vec4& _destRectPerc, const glm::vec4& _destRectPix, const std::string& _name /*= ""*/)
{
...
void GameEngine::GUI::SetWidgetDestRect(CEGUI::Window* _widget, const glm::vec4& _destRectPerc, const glm::vec4& _destRectPix)
{
...
void GameEngine::GUI::SetFont(const std::string& _fontFile)
{
  //set the font
