...
void GameEngine::DebugRenderer::DrawLine(const glm::vec2& _a, const glm::vec2& _b, const ColorRGBA8& _color)
{
  int i = m_verts.size();
...
void GameEngine::DebugRenderer::DrawBox(const glm::vec4& _destRect, const ColorRGBA8& _color, float _angle)
{
  int i = m_verts.size();
...
void GameEngine::DebugRenderer::DrawCircle(const glm::vec2& _center, const ColorRGBA8& _color, float _radius) 
{
...
void GameEngine::DebugRenderer::Render(const glm::mat4& _projectionMatrix, float _lineWidth)
{
